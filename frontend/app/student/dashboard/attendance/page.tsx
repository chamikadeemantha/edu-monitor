...
import { BookOpen, ArrowLeft, UserCheck, BarChart3 } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-4xl mx-auto p-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="text-sm font-medium text-gray-700">
              Student ID
              <input
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-200"
            ...
            <label className="text-sm font-medium text-gray-700">
              PIN (6 digits)
              <input
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-200 tracking-widest"
          ...
          {data?.module_code && (
            <div className="mt-6 rounded-lg bg-gray-50 border border-gray-200 p-4">
              ...
              {typeof data.remaining_slots === "number" && (
                <div className="text-sm text-gray-600 mt-1">
                  Remaining slots:{" "}
                  <span className="font-medium text-gray-900">{data.remaining_slots}</span>
                </div>
              )}
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Cards */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="text-sm text-gray-500">Last Module</div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <div className="text-sm text-gray-500">Attendance Records (local)</div>
            <div className="mt-2 text-3xl font-bold">{history.length}</div>
            <div className="text-sm text-gray-600 mt-1">Total marks done</div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div className="text-sm text-gray-600 mt-1">For current session</div>
          </div>
                    ...
                    <div key={m.module_code} className="w-full">
                      <div className="flex justify-between text-sm mb-1">
                        <div className="font-medium text-gray-800">
                          {m.module_code} — <span className="text-gray-600">{m.module_name}</span>
                        </div>
