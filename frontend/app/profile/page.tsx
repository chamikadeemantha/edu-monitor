        ...
        <div className="max-w-4xl mx-auto">
          ...
          {user.role === UserRole.STUDENT && (
            <button
              ...
              className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-800 border border-gray-700 hover:bg-gray-700/60 transition"
            >
              <ArrowLeft size={18} />
              Back to Dashboard
            </button>
              ...
              {user.role === UserRole.TEACHER && user.teacher_profile && (
                <>
                  ...
                  <ProfileField
                    ...
                    label="Experience"
                    value={`${user.teacher_profile.years_of_experience} Years`}
                  />
